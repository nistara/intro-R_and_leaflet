...
```{r echo = FALSE}
knitr::include_url("extras/One_page_summaRy.pdf")
```
Source: One-page summary of R commands by [Bianca Peterson](https://carpentries.org/blog/2019/05/R-tips-and-tricks/)
